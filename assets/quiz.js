...
let questions = [
  ...
  {
    text: "The Underwater Hockey World Championship was invented to what? ",
    options: [
      "Train Olympians on the West Coast",
      "Keep British Navy divers in shape",
      "Banish the aquaphobic tendencies of the founder’s children",
  ...
  },
  {
    ...
    options: ["USA", "Finland", "Spain", "India"],
    answer: "Finland",
  },
  {
    text: "Mobile Phone Throwing Championship winners receive a ….!",
    options: [
      "New phone",
      "New laptop",
      "10 minute snuggle session with 3 puppies",
